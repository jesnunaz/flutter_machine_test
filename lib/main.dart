...
import 'package:machine_test/src/features/product/presentation/views/home_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [ChangeNotifierProvider<ProductProvider>(create: (_) => ProductProvider())],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
